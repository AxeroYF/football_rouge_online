...
> 2026-08-18 最新权威状态请先阅读 `handoff/LATEST_20260818.md`。本轮完成 33 人大名单清退、超限球员锁定展示、扩容道具下架和管理员三种定向礼包。最新生产包为 `football-ydl-s4-roster-enforcement-designated-packs-hotfix-20260818.tar.gz`，SHA256 `1762d36291ec6838c592be2c36cf87ab09cd6747e8431861346f5e307a75f8f4`；服务器已完成上传校验，尚未确认部署后的健康检查。交接 ZIP 只用于恢复上下文，不是生产部署包。

> 2026-08-16 最新权威状态请先阅读 `handoff/LATEST_20260816.md`。最近完成默认职责修复、动态阵型预览和定位球主罚人明确化；修正版生产包为 `football-ydl-s4-dynamic-tactics-setpiece-hotfix-20260815-223403.tar.gz`，旧 `221900` 包因漏带 `versus/api.js` 禁止再次部署。体力机制仅完成分析，尚未修改代码。

> 2026-08-14 17:40 最新权威状态请先阅读 `handoff/LATEST_20260814.md`。本轮新增金球奖 V3 评分与一次性历史复核/全员公告；同时记录了尚未修复的阵容码导入和离开战术页覆盖风险。最新本地交接 ZIP 只用于恢复开发上下文，不是生产部署包。

> 2026-08-13 18:49 最新完整对话交接 ZIP 为 `handoff/football-ydl-s4-handoff-20260813-1849.zip`。最新合并生产热更新为 `handoff/football-ydl-s4-recent-batch-hotfix-20260813-183713.tar.gz`，SHA256 `649b46dd3a47f5c57ad74e244564cb60fd439495445e5e2cbf879ecfd3e29fc2`；尚未确认服务器部署。交接 ZIP 不是部署包。

> 2026-08-13 最新权威状态请先阅读 `handoff/LATEST_20260813.md`。最新对话交接 ZIP 为 `handoff/football-ydl-s4-handoff-20260813-1747.zip`，记录 8 月 13 日每日重启/OOM/延迟开赛修复、后台 502 分流、近期战术板与刷新逻辑，以及 V1 赔率/V2 实赛预测大样本脚本。该 ZIP 不是生产部署包。
